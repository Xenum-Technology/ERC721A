 ...
 */
contract ERC721AUpgradeable is ERC721Upgradeable, IERC721EnumerableUpgradeable {
    ...
    function _safeMint(
        ...
        require(!_exists(startTokenId), "ERC721AUpgradeable: token already minted");
        require(quantity <= maxBatchSize, "ERC721AUpgradeable: quantity to mint too high");
    ...
    function _mint(address to, uint256 tokenId) internal virtual override {
        ...
        uint256 updatedIndex = tokenId + 1;
